...
class Attention(nn.Module):
    ...
    def forward(self, h_src, h_t_tgt, mask=None):
        ...
        if mask is not None:
            ...
            # prepared mask(put 'True' in the location of pad)
...
class Encoder(nn.Module):
    ...
    def __init__(self, word_vec_size, hidden_size, n_layers=4, dropout_p=.2):
        ...
        self.rnn = nn.LSTM(
            word_vec_size,
            # because we use bi-directional RNN in the Encoder but, uni-directional in the Decoder
            int(hidden_size / 2),
            num_layers=n_layers,
            dropout=dropout_p,
            bidirectional=True,
...
class Decoder(nn.Module):
    ...
    def forward(self, emb_t, h_t_1_tilde, h_t_1):
        ...
        if h_t_1_tilde is None:
            ...
            # if we define with 'new', this means let's make new object with same device and same type
        ...
        # feed the previous hidden state and cell state
