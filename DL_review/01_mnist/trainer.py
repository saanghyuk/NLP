...
class Trainer():
    ...
    def _train(self, x, y, config):
        ...
        for i, (x_i, y_i) in enumerate(zip(x, y)):
            ...
            # if not float,loss_i become tensor.
            # computational graph
    ...
    def train(self, train_data, valid_data, config):
        # train data = [(batch_size, 784), (batch_size[label], )]
        # train data = [(valid_set_size, 784), (valid_set_size[label], )]
        lowest_loss = np.inf
        best_model = None
